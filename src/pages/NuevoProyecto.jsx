...
function InputUnidad({ value, onChange, unidad, error, ...props }) {
  return (
  ...
  return (
    <div style={{ maxWidth: 760 }}>
      <div className="breadcrumb mb-16">
        ...
        <span className="breadcrumb-current">{esEdicion ? 'Editar' : 'Nueva instalación'}</span>
      </div>
      ...
      <div className="card mb-16">
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <select className={`form-select${errores.modalidad ? ' error' : ''}`} value={form.modalidad} onChange={e => set('modalidad', e.target.value)}>
          ...
          <div className="form-group">
            <label className="form-label">Coste inversión</label>
            <InputUnidad value={form.coste_kwh_inversion} onChange={v => set('coste_kwh_inversion', v)}
              unidad="€/kWh" type="number" step="0.001" placeholder="0.050" />
          </div>
          <div className="form-group">
            <label className="form-label">Coste servicio</label>
            <InputUnidad value={form.coste_kwh_servicio} onChange={v => set('coste_kwh_servicio', v)}
              unidad="€/kWh" type="number" step="0.001" placeholder="0.020" />
          </div>
          <div className="form-group">
            <label className="form-label">Coste mantenimiento</label>
            <InputUnidad value={form.coste_anual_mantenimiento_por_kwp} onChange={v => set('coste_anual_mantenimiento_por_kwp', v)}
      ...
      <div className="card mb-16">
        ...
        <div className="form-grid">
          <div className="form-group">
            <label className="form-label">CUPS generador</label>
      ...
      <div className="flex-row" style={{ justifyContent: 'flex-end', gap: 10 }}>
        <button className="btn" onClick={() => navigate(esEdicion ? `/proyectos/${id}` : '/proyectos')}>Cancelar</button>
