...
export default function Documentos() {
  ...
  async function cargarInstalacion() {
    ...
    if (!inst?.cups_generador) nuevasAlertas.push({ tipo: 'warning', msg: 'La instalación no tiene CUPS generador. Aparecerá en blanco en los documentos.' })
  ...
  function handleGenerarTxtReparto() {
    ...
    if (!instalacion.cups_generador) {
      alert('La instalación no tiene CUPS generador configurado')
      return
    }
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: 8, padding: '12px 14px', background: 'var(--bg-subtle)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
                  ...
                  <button
                    ...
                    disabled={generandoColectivo || !installationId || participes.length === 0}
